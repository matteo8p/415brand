...
export const deepgramDaily: Brief = {
  ...
  "intro": [
    {
      "type": "why",
      "text": "**Today's three moves:** (1) Open a pull request adding Sprag to [openclaw](https://github.com/openclaw/openclaw). It has 388,284 stars, Deepgram is already a plug-in extension there, and that extension is a template Sprag can copy. (2) Write to [Elios in London](https://www.linkedin.com/posts/americanitsystems_jobopening-hiring-nowhiring-activity-7500226376768106496-Skn0). Their job ad prints the stack, Deepgram is the transcriber, and they are hiring the engineer who will own it. (3) Reply to [Ian Jones on X](https://x.com/pburghdoom/status/2094530719376875723). Flux returned twelve seconds of a caller as three settled segments and his agent overwrote each one. Nobody has answered him."
    }
  ],
  "sections": [
    {
      ...
      "blocks": [
        {
          ...
          "items": [
            {
              "text": "Deepgram shipped nothing on Aug 30 or 31. Its last release was [Aug 28](https://developers.deepgram.com/changelog/2026/8/28): turn-taking control for Flux, and improved Nova-3 models for ten languages including Marathi and Telugu. The language releases are running weekly and they are aimed at Sprag's wedge.",
              "tone": "neutral"
            },
            {
              "text": "Deepgram started paying members of the public for 90-second voice recordings in any accent or dialect, to train expressive text to speech. It is buying the long-tail voice data that open-weight models do not have.",
              "tone": "bad"
            },
            {
              "text": "Flux TTS is free until Sept 12 and Deepgram's list price rises Sept 13. Twelve days of free onboarding land immediately before the number Sprag beats.",
              "tone": "bad"
            },
            {
              "text": "Deepgram named its first DACH sales development rep on Aug 31 and called it the founding Central Europe GTM team. German-speaking accounts are about to get called.",
              "tone": "bad"
            },
            {
        ...
        {
          "type": "note",
          "text": "Follow up tomorrow: whether anyone answered @pburghdoom, and whether Elios posts the role on its own page with a named hiring manager."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "type": "note",
          "text": "Pulled Sept 1, 2026. The window is Aug 30 and 31. X search for Deepgram over the last 48 hours, latest and top. Reddit search for Deepgram, newest first, back to Aug 29, because this is the first daily brief and Reddit was not in the Aug 31 weekly. LinkedIn keyword search for Deepgram over the last week, with every reaction and comment on each post read for job title and employer, plus every post and engager on the Deepgram, Soniox and Cartesia company pages. GitHub commit search for Deepgram since Aug 30, and code search for api.deepgram.com, DEEPGRAM_API_KEY, deepgram-sdk and the Python and realtime imports, with every repository returned ranked by stars. G2 reviews of Deepgram, most recent first. Deepgram's changelog. Hacker News, which had nothing in the window. Reach is likes, replies, reposts, upvotes and comments as each site reported them at pull time. Job titles and employers are as written on each person's own profile. LinkedIn does not publish the date of a reaction, so where a row rests on a reaction the date shown is the post's. No advertising pull ran today, so search and display advertising is covered in the Aug 31 weekly instead."
        }
      ]
    }
  ],
