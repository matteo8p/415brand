...
export const viktor: Brief = {
  ...
  footer:
    "Traffic, search and ad-spend figures are estimates and disagree by up to two to one, so trust the trends and ratios. Revenue figures are unaudited. Pulled Aug 26 to 27, 2026.",
  sources: {
