# Posts to ignore: Experiential Labs
...
| # | Rule | Why |
|---|---|---|
| 1 | **The education namespace.** Any hit on "experiential lab(s)" meaning a school facility, teaching method, or campus. | The Reddit pull on the company name returned almost nothing else. Pure search artefact. |
...
### Not a rule, deliberately
**Do not filter out the caching objection or other criticism of Experiential.** It is the most useful thing we can hand them, and the first report should include every instance. Confirm they want it that way, but the default is to show it.

## Changelog
- **2026-08-28.** File created from the first research run. Rules 1 to 7 proposed, none confirmed.
