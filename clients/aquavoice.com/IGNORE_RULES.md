...
(`AQUA_VOICE.md`), from `skills/FIND_LEADS.md` section 5, and from what carried over from Cloudless
...
- **Japanese-language posts.** If the ">50% of users are in Japan" figure holds, these are not noise —
  ...
  filter them until Finn has answered the question in `README.md`.
- **Cloudless mentions.** Cloudless is a paying client of ours and a direct competitor of Aqua.
  ...
  See the conflict notice in `README.md`.

## Changelog

- **2026-08-31** — file created with rules 1–13 proposed, none confirmed. Rules 8–12 carried over
  from `cloudless.so/IGNORE_RULES.md` (same subject, same pulls). Rules 1–4, 6–7 are Aqua-specific and
  derive from the product gaps listed in `AQUA_VOICE.md`.
