...
*Research date: 2026-08-27. Sources: crawls of tryopentag.com, dust.tt and conifer.build; press coverage of Claude Tag (Fortune, VentureBeat, eesel); and research415's own prior research files `clients/adapt/research/adapt.md` and `clients/adapt/research/viktor.md` (both dated 2026-08-26), which contain far more depth on those two companies than is repeated here. Read `opentag.md` first — this file assumes it. Items marked **[unverified]** come from a single third-party source.*

> ## ⚠️ Client conflict — read before any work ships
>
> **Adapt.com is already a research415 client** (`clients/adapt/`), and Adapt sells the same product to the same buyer as OpenTag: one shared AI agent, living in Slack, connected to company tools, usage-priced with unlimited seats, routing across Claude/GPT/Gemini/open models. They are direct competitors.
>
...
**The watch item:** every one of those August G2 complaints is a named reviewer with a role and a company. That is A-tier evidence under `.claude/skills/competitor-customers/SKILL.md` and the highest-yield first pull for OpenTag's lead gen.
...
**Company.** Adapt.com Inc, San Francisco. Jim Benton (CEO; previously ran Chorus.ai to a $575M ZoomInfo exit and was CEO at Apollo.io), Sean Smith (CTO), John Andrew Entwistle. **$10M seed, 29 January 2026**, co-led by Activant Capital and Headline. GA 10 April 2026. **SOC 2 Type II certified 5 June 2026.** Full detail in `clients/adapt/research/adapt.md`.
...
| **The open-source OpenTags** | `fancyboi999/open-tag` bills itself as a self-hostable Claude Tag alternative; three more repos share the name | Not a commercial threat yet. They *are* a brand and discovery problem — see `opentag.md`, "The name problem" |
...
tryopentag.com and conifer.build (Firecrawl crawl, 2026-08-27). dust.tt/pricing (2026-08-27). Fortune (23 Jun 2026), VentureBeat and eesel on Claude Tag. `clients/adapt/research/adapt.md` and `clients/adapt/research/viktor.md` (research415 research, 2026-08-26) — subject to the conflict notice above. G2, Crunchbase and press figures for Viktor as cited in `clients/adapt/research/viktor.md`.
